...
- **Active milestone:** M4 — Presentable: **not started.** **P9 — Rendering, Audio & Visual Grammar is the next phase** (it also inherits the deferred P8/P9 shares of REQ-130/131/132 per dm-0065/dm-0072); its execution-plan section must be authored before S9.1 code (REQ-P02), per the same discipline every phase since P2 got. P10 (Content Generation) is now unblocked by M3 but follows P9 in the DAG.
