...
- **Active milestone:** M2 — Design Intelligence Operational (P4 ✓, P5 ✓, P6). **P6 — Campaign Intelligence is the next phase** (entry conditions satisfied); its execution-plan section must be authored before S6.1 code (REQ-P02). The content-generation hard gate stays closed until M2 is fully VERIFIED (P6 remains).
- **All later phases (P6–P11):** still NOT_STARTED and correctly gated.
